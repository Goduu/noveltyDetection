...
ht_regressor = pickle.load(open('models/ht_regressor12F.p', 'rb'))
...
try:
    ...
    while True:
        ...
        ht_regressor = increment_model(ht_regressor)
        time.sleep(3)
        logging.info("[ML] Saving model at 'models/ht_regressor12F'...")
